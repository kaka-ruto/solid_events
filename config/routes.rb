...
SolidEvents::Engine.routes.draw do
  ...
  get "api/incidents/:id/evidences", to: "api#incident_evidences", as: :api_incident_evidences
  ...
  get "api/journeys/materialized", to: "api#materialized_journeys"
  get "api/causal_edges", to: "api#causal_edges"
